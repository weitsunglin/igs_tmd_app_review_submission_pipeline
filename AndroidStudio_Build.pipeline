        ...
        stage('Change app Name and Throw to desktop') {
            steps {
                script {
                    ...
                    def appSource = ""
                    def appDirection = "/Users/tmd/Desktop/production_android_app/"
                    ...
                    sh """
                    mv '${appDirection}proj.android-release.${params.BUILD_TYPE}' '${appDirection}${params.NDK_TYPE}-release.${params.BUILD_TYPE}' 
                    """
