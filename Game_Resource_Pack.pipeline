            ...
            steps {
                script { 
                    try {
                        ...
                        echo "Error in 'Get Game SVN Path' stage: ${e.getMessage()}"
                    }
                }
            }
        }
            ...
            steps {
                script {
                    try {
                        ...
                        echo "Error in 'Game Switch Path using SVN' stage: ${e.getMessage()}"
                    }
                }
            }
        }
                ...
                dir(PROJ_ANDROID_URL) {
                    script { 
                        try {
                            ...
                            // Assuming the script is executed here, add execution command within the try block
                        } catch (Exception e) {
                            echo "Error in 'Lua Encode Dat' stage: ${e.getMessage()}"
                        }
                    }
                }
            }
                ...
                script { 
                    try {
                        ...
                        for(url in SVN_URLS) {
                            ...
                            // Logic to add game resource configurations
                        ...
                        // Writing the JSON content to build-cfg-original.json
                        writeFile file: PROJ_ANDROID_URL + "build-cfg-original.json", text: jsonContent
                    } catch (Exception e) {
                        echo "Error in 'Modify build-cfg-original.json' stage: ${e.getMessage()}"
                    }
                }
            }
        }
                ...
                dir(PROJ_ANDROID_URL) {
                    script {
                        try {
                            ...
                            echo "Error during 'Packing' stage: ${e.getMessage()}"
                        }
                    }
                }
            }
                        ...
                        dir(PROJ_ANDROID_URL) {
                            script {
                                try {
                                    ...
                                    echo "Error reverting changes in 'Clean Build CFG Original' stage for URL ${url}: ${e.getMessage()}"
                                }
                            }
                        }
                    }
